...
public class EmailConfigResource {
    ...
    public ResponseEntity<EmailConfig> createEmailConfig(@RequestBody EmailConfig emailConfig) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/email-configs/" + emailConfig.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, emailConfig.getId().toString()))
            .body(emailConfig);
    }
    ...
    public ResponseEntity<EmailConfig> updateEmailConfig(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, emailConfig.getId().toString()))
            .body(emailConfig);
    }
    ...
    public ResponseEntity<EmailConfig> partialUpdateEmailConfig(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, emailConfig.getId().toString())
        );
    }
